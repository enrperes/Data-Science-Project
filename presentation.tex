...
\includegraphics{presentation_files/figure-beamer/Nadal Serve position-1.pdf}
\end{column}

\begin{column}{0.48\textwidth}
\includegraphics{presentation_files/figure-beamer/Djokovic serve position-1.pdf}
\end{column}
\end{frame}

\begin{frame}{{First} and {second} serve speeds}
\protect\hypertarget{first-and-second-serve-speeds}{}
\includegraphics{presentation_files/figure-beamer/plot grid serve speed-1.pdf}
\end{frame}

\begin{frame}{Strikepoint density map}
\protect\hypertarget{strikepoint-density-map}{}
\includegraphics{presentation_files/figure-beamer/strikepoint Nadal-1.pdf}
\end{frame}
